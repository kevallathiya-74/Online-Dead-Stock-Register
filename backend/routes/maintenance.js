...
router.get(
  "/warranties/export",
  authMiddleware,
  maintCtrl.exportWarrantyReport,
);
...
router.post(
  ...
  requireRole(["ADMIN", "INVENTORY_MANAGER"]),
  validateObjectId("id"),
  maintCtrl.extendWarranty,
);
router.get(
  "/warranties/:id/claims",
  authMiddleware,
  validateObjectId("id"),
  maintCtrl.getWarrantyClaimHistory,
);
...
router.get(
  ...
  authMiddleware,
  validateObjectId("id"),
  maintCtrl.getMaintenanceById,
);
router.put(
  "/:id",
  authMiddleware,
  validateObjectId("id"),
  maintCtrl.updateMaintenanceRecord,
);
router.delete(
  "/:id",
  authMiddleware,
  validateObjectId("id"),
  maintCtrl.deleteMaintenanceRecord,
);
