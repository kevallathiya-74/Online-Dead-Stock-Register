...
const options = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description:
        "Comprehensive API documentation for the Dead Stock Asset Management System",
      contact: {
        name: "API Support",
      ...
      schemas: {
        ...
        Asset: {
          ...
          properties: {
            ...
            purchasePrice: { type: "number", example: 1200.0 },
            currentValue: { type: "number", example: 800.0 },
            status: {
              type: "string",
