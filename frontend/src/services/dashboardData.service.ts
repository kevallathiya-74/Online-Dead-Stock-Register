...
export class DashboardDataService {
  ...
  async getAuditItems(): Promise<unknown[]> {
  ...
  async getChartData(chartType: 'asset_trends' | 'maintenance_trends' | 'purchase_trends'): Promise<unknown> {
  ...
  async getRealtimeUpdates(): Promise<unknown> {
